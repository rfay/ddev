...
func (app *DdevApp) AddHostsEntriesIfNeeded() error {
	...
	if ipPosition != -1 && runtime.GOOS == "windows" {
		...
		if len(hostsLine.Hosts) >= 10 {
			...
			util.Error("Please see %s for more information", "https://ddev.readthedocs.io/en/stable/users/basics/troubleshooting/#windows-hosts-file-limited-to-10-hosts-per-line")
		}
	}
